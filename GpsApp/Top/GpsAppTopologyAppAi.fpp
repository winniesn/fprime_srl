...
instance gpsImpl: GpsApp.Gps base id 321

instance gpsSerial: Drv.LinuxSerialDriver base id 481

instance blockDrv: Drv.BlockDriver base id 10001
...
topology GpsApp {
  ...
  connections XML {
    ...
    gpsImpl.cmdRegOut[0] -> cmdDisp.compCmdReg[7]
    ...
    cmdDisp.compCmdSend[7] -> gpsImpl.cmdIn[0]
    ...
    gpsImpl.cmdResponseOut[0] -> cmdDisp.compCmdStat[0]
    ...
    gpsImpl.eventOut[0] -> eventLogger.LogRecv[0]
    gpsSerial.Log[0] -> eventLogger.LogRecv[0]
    ...
    gpsSerial.LogText[0] -> textLogger.TextLogger[0]
    gpsImpl.textEventOut[0] -> textLogger.TextLogger[0]
    ...
    gpsImpl.tlmOut[0] -> chanTlm.TlmRecv[0]
    gpsSerial.Tlm[0] -> chanTlm.TlmRecv[0]
    ...
    gpsSerial.Time[0] -> linuxTime.timeGetPort[0]
    gpsImpl.Time[0] -> linuxTime.timeGetPort[0]
    ...
    rateGroup1Comp.RateGroupMemberOut[0] -> chanTlm.Run[0]
    rateGroup1Comp.RateGroupMemberOut[1] -> fileDownlink.Run[0]
    ...
    rateGroup3Comp.RateGroupMemberOut[1] -> blockDrv.Sched[0]
    ...
    gpsSerial.serialRecv[0] -> gpsImpl.serialRecv[0]
    gpsImpl.serialBufferOut[0] -> gpsSerial.readBufferSend[0]
  }
